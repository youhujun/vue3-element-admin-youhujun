...
export default [
  ...
  // TypeScript 文件特定配置
  {
    ...
    rules: {
      ...
      // 关键修改：从单纯的 "warn" 改为数组形式，添加忽略下划线前缀的配置
      "@typescript-eslint/no-unused-vars": [
        "warn", // 保留原有：降级为警告
        {
          argsIgnorePattern: "^_", // 忽略以下划线开头的函数参数（如 _param、_oldValue）
          varsIgnorePattern: "^_", // 忽略以下划线开头的变量（如 const _param = xxx）
          caughtErrorsIgnorePattern: "^_", // 可选：忽略以下划线开头的catch错误变量（如 catch (_err)）
        },
      ],
