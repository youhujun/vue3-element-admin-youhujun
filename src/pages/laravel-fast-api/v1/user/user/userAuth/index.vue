 ...
 * @LastEditTime: 2025-12-10 03:39:21
 * @FilePath: d:\wwwroot\Open\Vue\vue3-element-admin-youhujun\src\pages\laravel-fast-api\v1\user\user\userAuth\index.vue
      ...
      <template #cardContent>
        ...
        <YhTableLayout>
          ...
          <template #search>
            ...
            <UserAuthSearch @update:handle-change-search="toSearch"></UserAuthSearch>
          </template>
          <!-- 搜索区结束 -->
          <!-- 批量操作区开始 -->
          <template #batch>
...
//页面级组件
import UserAuthSearch from "./components/UserAuthSearch.vue";
import UserAuthTableList from "./components/UserAuthTableList.vue";
import CreateUserAuthForm from "./components/CreateUserAuthForm.vue";
////api和type
