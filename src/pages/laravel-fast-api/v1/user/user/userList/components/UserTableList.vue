 ...
 * @LastEditTime: 2025-12-09 22:10:08
 * @FilePath: d:\wwwroot\Open\Vue\vue3-element-admin-youhujun\src\pages\laravel-fast-api\v1\user\user\userList\components\UserTableList.vue
...
<template>
  <div>
    ...
    >
      ...
      <el-table-column align="center" scope="phone" label="手机号" min-width="200" fixed />
      <el-table-column align="center" scope="account_name" label="账号" width="150" />
      <el-table-column align="center" scope="real_name" label="姓名" width="200" />
      <el-table-column align="center" scope="nick_name" label="昵称" min-width="300" />
      <el-table-column
        scope="real_auth_status"
        label="认证状态"
        width="150"
        :filters="[
          { text: '未认证', value: '10' },
      ...
      <el-table-column align="center" scope="created_at" label="注册时间" min-width="200" />
...
//组件
import UserListItemDetails from "./UserListItemDetails.vue";
