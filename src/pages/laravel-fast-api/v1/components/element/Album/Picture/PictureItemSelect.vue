 ...
 * @LastEditTime: 2025-12-10 02:03:27
 * @FilePath: d:\wwwroot\Open\Vue\vue3-element-admin-youhujun\src\pages\laravel-fast-api\v1\components\element\Album\Picture\PictureItemSelect.vue
    ...
    <div class="picture-box">
      ...
      <div class="picture-footer">
        <div class="picture_name">
          <el-row>
            <el-col :span="24">
              <div class="ellipsis-text">{{ pictureName }}</div>
            </el-col>
          </el-row>
        </div>
