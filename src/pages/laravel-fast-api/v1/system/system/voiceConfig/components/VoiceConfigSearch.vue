 ...
 * @LastEditTime: 2025-12-10 03:35:47
 * @FilePath: d:\wwwroot\Open\Vue\vue3-element-admin-youhujun\src\pages\laravel-fast-api\v1\system\system\voiceConfig\components\VoiceConfigSearch.vue
          ...
          >
            <template #prepend>
              <el-select v-model="where.findSelectIndex" placeholder="请选择">
                <el-option label="提示音标题" :value="0" />
                <el-option label="提示音渠道" :value="1" />
                <el-option label="提示音事件" :value="2" />
              </el-select>
            </template>
            <template #append>
