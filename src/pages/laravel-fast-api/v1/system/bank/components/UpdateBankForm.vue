  ...
  <div>
    ...
    >
      ...
      <el-row type="flex" justify="center">
        <el-col :span="24">
          <el-form-item label="类型" prop="type">
            <el-select v-model="updateForm.is_default" placeholder="请选择" class="select">
              <el-option
      ...
      <el-row type="flex" justify="center" style="text-align: center">
        <el-col :span="12">
          <el-form-item>
            <el-button type="primary" @click="submitForm(updateFormRef)">修改银行</el-button>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item>
...
import type { UpdateBank } from "@/api/laravel-fast-api/v1/system/bank/bank-type";
...
const updateRules = reactive<FormRules<UpdateBank>>({
  ...
  bank_code: [{ type: "string", message: "银行编码不正确", trigger: "blur" }],
  is_default: [{ type: "number", required: true, message: "必须有值", trigger: "blur" }],
});
...
const submitForm = async (formEl: FormInstance | undefined) => {
  ...
  try {
    ...
    if (valid) {
      ...
      const result = await SystemBankAPI.updateBank(updateForm);
      // 3. 提交成功提示
