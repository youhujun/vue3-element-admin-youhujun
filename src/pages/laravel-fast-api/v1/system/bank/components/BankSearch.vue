 ...
 * @LastEditTime: 2025-12-10 02:46:15
 * @FilePath: d:\wwwroot\Open\Vue\vue3-element-admin-youhujun\src\pages\laravel-fast-api\v1\system\bank\components\BankSearch.vue
          ...
          >
            <template #prepend>
              <el-select v-model="where.findSelectIndex" placeholder="请选择">
                <el-option label="银行名称" :value="0" />
                <el-option label="银行编码" :value="1" />
              </el-select>
            </template>
            <template #append>
