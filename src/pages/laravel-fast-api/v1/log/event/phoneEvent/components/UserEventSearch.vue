 ...
 * @LastEditTime: 2025-12-05 16:21:07
 * @FilePath: \src\pages\laravel-fast-api\v1\log\event\phoneEvent\components\UserEventSearch.vue
...
<template>
  <div>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="12">
        <div class="inline">
          <el-tag style="height: 2rem; line-height: 2rem" type="info">用户选项</el-tag>
          <SelectUser v-model:select-user-id="where.user_id"></SelectUser>
        </div>
      </el-col>
      <!-- 第一列结束 -->
      <!-- 第二列开始 -->
