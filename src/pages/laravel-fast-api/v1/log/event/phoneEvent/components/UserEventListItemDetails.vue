 ...
 * @LastEditTime: 2025-12-05 16:19:43
 * @FilePath: \src\pages\laravel-fast-api\v1\log\event\phoneEvent\components\UserEventListItemDetails.vue
  ...
  <div class="expanded">
    <div class="header">
      <el-row type="flex">
        ...
        <!-- <el-button type="primary" :icon="Avatar" size="small" @click="handleClick(2)">UserEventTwo</el-button> -->
      </el-row>
    </div>
    <div class="content">
      <!-- 简单的处理开始 -->
...
//组件(复杂逻辑使用)
// import UserEventOne from './ListItemDetails/UserEventOne.vue'
//import UserEventTwo from './ListItemDetails/UserEventTwo.vue'
...
//定义组件名称
defineOptions({
  name: "UserEventListItemDetails",
});
//控制显示的组件
const showComponent = ref(1);
//定义行数据
const rowData = defineModel<UserEventLogListItem>("rowData", {
  default: () => ({
    id: 0,
    created_at: "",
    admin_id: 0,
