 ...
 * @LastEditTime: 2025-12-05 13:55:39
 * @FilePath: \src\pages\laravel-fast-api\v1\log\event\adminEvent\components\AdminLoginSearch.vue
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="12">
        <div class="inline">
          ...
          <SelectAdmin v-model:select-admin-id="where.admin_id"></SelectAdmin>
        </div>
      </el-col>
      <!-- 第一列结束 -->
      <!-- 第二列开始 -->
...
import SelectAdmin from "@/pages/laravel-fast-api/v1/components/element/Admin/SelectAdmin.vue";
import { throttle } from "@/utils";

//定义组件名称
defineOptions({
  name: "AdminLoginSearch",
});
