 ...
 * @FilePath: \src\pages\laravel-fast-api\v1\log\login\adminLogin\components\UserLoginListItemDetails.vue
  ...
  <div class="expanded">
    <div class="header">
      <el-row type="flex">
        ...
        <!-- <el-button type="primary" :icon="Avatar" size="small" @click="handleClick(2)">UserLoginTwo</el-button> -->
      </el-row>
    </div>
    <div class="content">
      <!-- 简单的处理开始 -->
...
//定义组件名称
defineOptions({
  name: "UserLoginListItemDetails",
});
//控制显示的组件
const showComponent = ref(1);
//定义行数据
const rowData = defineModel<UserLoginLogListItem>("rowData", {
  default: () => ({
    id: 0,
    created_at: "",
    admin_id: 0,
