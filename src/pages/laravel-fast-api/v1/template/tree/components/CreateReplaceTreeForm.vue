      ...
      <el-row type="flex" justify="center">
        <el-col :span="24">
          <el-form-item label="替换内容" prop="replace_name">
            <el-input v-model="createForm.replace_name" placeholder="提示内容" clearable />
          </el-form-item>
        </el-col>
      </el-row>
...
import type { AddReplace } from "@/api/laravel-fast-api/v1/replace/replace/tree-replace-type";
//定义组件名称
defineOptions({
  name: "CreateReplaceTreeForm",
});
