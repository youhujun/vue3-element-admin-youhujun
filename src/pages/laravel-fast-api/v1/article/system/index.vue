 ...
 * @LastEditTime: 2025-12-10 04:38:56
 * @FilePath: d:\wwwroot\Open\Vue\vue3-element-admin-youhujun\src\pages\laravel-fast-api\v1\article\system\index.vue
...
<template>
  <div>
    <!-- 页面内容开始 -->
    <YhCard>
      <template #cardTitle>系统文章</template>
      <template #cardNotice>
        <el-tag size="small" type="danger" effect="plain">提示:可以编辑全局模块文章</el-tag>
      </template>
      <template #cardButton>
      ...
      <template #cardContent>
        ...
        <YhTableLayout>
          ...
          <template #search>
            ...
            <ArticleSearch @update:handle-change-search="toSearch"></ArticleSearch>
          </template>
          <!-- 搜索区结束 -->
          <!-- 批量操作区开始 -->
          <template #batch>
...
import ArticleTableList from "./components/ArticleTableList.vue";
import CreateArticleForm from "./components/CreateArticleForm.vue";
import UpdateArticleForm from "./components/UpdateArticleForm.vue";
//业务接口
